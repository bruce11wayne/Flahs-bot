...
const smsAvisoAG = () => { return `╰⊱⚠️⊱ *تنبيه خطأ* ⊱⚠️⊱╮\n\n` }
...
//main.js
const smsWelcome = () => { return `*╭┈⊰* 🚀الــتــرحــيــب🚀 *⊰┈ ✦*\n*┊˹📯˼┊ اهــلا بــك*\n┊˹🥷🏻˼┊ @user\n┊📩 *اقرأ وصف المجموعة*\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈ ✦*\n${String.fromCharCode(8206).repeat(850)}\n> *منور الجروب يا قلب اونوهانا ┊˹✅˼┊*`}
const smsBye = () => { return '*╭┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*\n┊ @user\n┊ *مش هتوحشنا ابداً 👋🏻❤️‍🩹*\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*'}
const smsSpromote = () => { return '*[ 📯 ] @user تمت ترقيتك إلى مستبد.*'}
const smsSdemote = () => { return '*[ 📯 ] @user تم تخفيض رتبتك من مستبد.*'}
